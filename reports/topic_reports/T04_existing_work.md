...
| HuggingFace direct artifacts | 1 |
...
|---|---|---|---|---|---|---|---|
| 1 | github | [reacher-z/ClawBench](https://github.com/reacher-z/ClawBench) |  | GitHub | benchmark | 196 | strong |
| 2 | huggingface | [potsawee/chatbot-arena-llm-judges](https://huggingface.co/datasets/potsawee/chatbot-arena-llm-judges) |  | HuggingFace | dataset | 170 | strong |
